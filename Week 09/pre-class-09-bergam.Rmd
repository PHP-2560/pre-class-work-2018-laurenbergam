...
webpage <- getURL(url)
data <- readHTMLTable(webpage, stringAsFactors = FALSE,
                      which = 2)
...
stock_sectors <- readHTMLTable(webpage, stringAsFactors = FALSE,
                      which = 2)
...
whats_moving <- readHTMLTable(webpage, stringAsFactors = FALSE,
                      which = 1)
...
latest_news <- readHTMLTable(webpage, stringAsFactors = FALSE,
                      which = 3)
